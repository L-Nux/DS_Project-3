# -*- coding: utf-8 -*-
"""merging&visualizations true.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1gFhjEFSUgyleczD0HTN3KZG1Hgy3hLpR
"""
...
"""1st picture- the top 3 lomg travel label combinations are train+flixbus, blablacar+flixbus, flixbus+train+flixbus, 2d picture-The ranking of labels have changed when using mean travl time,the top 1 became bus,car,train,bus"""
...
"""left picture-  the more waiting time we have- the more travel time would it be for the trip, all transport and noflights are the leads from the mode perspective wrt to travelling time except the first binning range where the ptonly is the longest with time

right picture- if the customers do not want to wait a lot-the price would be significantly higher, its easy to follow the pattern-more time to wait-less money to pay (especially with the public transport) for 3 binning ranges out of 5
"""
...
# create and generate a word cloud image, set a max range of words-top 3
...
"""The most proposed mode of travel is land-based and includes flixbus or rail transportation, which was also detected previously via other samples and plotting techniques"""
...
#plot the pie chart for the merged df (2dim +3dim)
