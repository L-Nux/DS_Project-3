...
Original file is located at
    https://colab.research.google.com/drive/1-82svHUqpWO6hoogytfVSxBHmouj3GuX
"""
...
super hight ratio of false negatives for flight label (4th)- it was predicted that the flight was not involved but actually it is involved- as a result customer didnt prepare well for the trip
"""
...
delay feature mostly pushed the predictions of 4th class flixbus and least of flight-class 3(4th label)
"""
...
"""almost the same pattern for the 3d model based on 1000 records as sample, safety boost is a bit more important on scale, balancing of clusses puched towards is the same-nn with labelwise smote"""
