...
Original file is located at
    https://colab.research.google.com/drive/14_LE-cN5Nn9rZSeYWCJUs2rqLd215RiQ
"""
...
if best_recommendation_df.meal_option.to_string(index=False) == "catering trolley, on-board catering with 2-g rule":
                        ...
                        st.write(
                            ":snack: You can either prepare you own simple snacks and drinks in advance or purchase them on board the bus. "
                            "destination__")
                        ...
                        st.write(
                            ":food: Your trip includes an airplane, where meals are already included and a train where, according to the 2-g rule, you can get service in a restaurant. If you want to eat more on the bus, you can buy light snacks on board"
                            "destination__")
                        ...
                        st.write(
                            ":food: Your trip includes an airplane where meals are already included. If you want to eat more on the bus, you can buy light snacks on board or prepare the cold dishes & drinks in advance"
                            "destination__")